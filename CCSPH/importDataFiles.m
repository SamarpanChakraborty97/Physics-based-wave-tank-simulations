...
pathToHere            = 'D:/CCSPH_GPU/x64/Debug/';
pathToSPHCode         = 'D:/CCSPH_GPU/x64/Debug/';
...
if 1
    ...
    while ind1 <= nFiles
        ...
        save D:/CCSPH_GPU/x64/Debug/PosFreePart4 Freeparticles
    
        DensityFreeParticles = s(I,3);
        save D:/CCSPH_GPU/x64/Debug/DensityFreePart4 DensityFreeParticles
    
    
        I1 = find(s(:,4)==2);
        Contparticles = s(I1,1:2);
        save D:/CCSPH_GPU/x64/Debug/PosContPart4 Contparticles
    
        DensityContainerParticles = s(I1,3);
        save D:/CCSPH_GPU/x64/Debug/DensityContPart4 DensityContainerParticles
