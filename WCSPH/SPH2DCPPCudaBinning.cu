...
int main(int argc, char* argv[])
{
	...
	*/
	...
	//particles->phaseValues1 = new double[totPhaseValues];
	//particles->phaseValues2 = new double[totPhaseValues];
	//particles->phaseValues3 = new double[totPhaseValues];
	//particles->phaseValues4 = new double[totPhaseValues];
	//particles->phaseValues5 = new double[totPhaseValues];
	//particles->phaseValues6 = new double[totPhaseValues];
	particles->Ai = new double[components];
	particles->Bi = new double[components];
	particles->fi = new double[components];
	particles->ki = new double[components];

	//initialize some of the memory
	for (int ind1 = 0; ind1 < totalNumberOfParticles; ind1++) { particles->vx[ind1] = 0; particles->vy[ind1] = 0; particles->density[ind1] = 1000; particles->pressure[ind1] = 0; };
