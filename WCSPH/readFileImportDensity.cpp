...
int readFileImportDensity(int* nP, particleStructure* particles, paramsType* params, std::vector<struct kinematicsFunctionStructure>* kinematicsFunction, std::string inputFile) {
	...
	/*****	READING IN VELOCITY IN THIS VERSION*****/
	/*
	//read vx values
	for (int ind1 = 0; ind1 < nP[0]; ind1++) {
		fscanf(pFile, "%f", &temp);
	...
	*/
	...
	for (int ind1=0; ind1<nP[1]; ind1++){
		fscanf(pFile,"%f",&temp);
		particles->vx[nP[0] + ind1] = temp;
	};

	//read vy values
	for (int ind1=0; ind1<nP[1]; ind1++){
		fscanf(pFile,"%f",&temp);
		particles->vy[nP[0] + ind1] = temp;
	};
	*/
	...
	*/
	...
	/*
	int totalPhaseValues = 10;
	for (int ind1 = 0; ind1 < totalPhaseValues; ind1++) {
		fscanf(pFile, "%f", &temp);
		particles->phaseValues1[ind1] = temp;
	};

	for (int ind1 = 0; ind1 < totalPhaseValues; ind1++) {
		fscanf(pFile, "%f", &temp);
		particles->phaseValues2[ind1] = temp;
	};

	for (int ind1 = 0; ind1 < totalPhaseValues; ind1++) {
		fscanf(pFile, "%f", &temp);
		particles->phaseValues3[ind1] = temp;
	};

	for (int ind1 = 0; ind1 < totalPhaseValues; ind1++) {
		fscanf(pFile, "%f", &temp);
		particles->phaseValues4[ind1] = temp;
	};

	for (int ind1 = 0; ind1 < totalPhaseValues; ind1++) {
		fscanf(pFile, "%f", &temp);
		particles->phaseValues5[ind1] = temp;
	};

	for (int ind1 = 0; ind1 < totalPhaseValues; ind1++) {
		fscanf(pFile, "%f", &temp);
		particles->phaseValues6[ind1] = temp;
	};
	*/
	int components = 80;
	for (int ind1 = 0; ind1 < components; ind1++) {
		fscanf(pFile, "%f", &temp);
		particles->Ai[ind1] = temp;
	};

	for (int ind1 = 0; ind1 < components; ind1++) {
		fscanf(pFile, "%f", &temp);
		particles->Bi[ind1] = temp;
	};

	for (int ind1 = 0; ind1 < components; ind1++) {
		fscanf(pFile, "%f", &temp);
		particles->fi[ind1] = temp;
	};

	for (int ind1 = 0; ind1 < components; ind1++) {
		fscanf(pFile, "%f", &temp);
		particles->ki[ind1] = temp;
	};
